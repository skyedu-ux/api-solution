...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/17-D0DGUUkx.js')),
			__memo(() => import('./chunks/18-DqTdCguk.js')),
			__memo(() => import('./chunks/19-DD63rhL1.js')),
			__memo(() => import('./chunks/20-B2M4mr3p.js')),
			__memo(() => import('./chunks/21-CHqZbAex.js')),
			__memo(() => import('./chunks/22-BQqzSaED.js')),
			__memo(() => import('./chunks/23-Dif6Bqde.js')),
			__memo(() => import('./chunks/24-CkNlVK-j.js'))
		],
		routes: [
			{
				id: "/(user)",
