...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/16-BjBAW7FL.js')),
			__memo(() => import('./chunks/17-f4S988T1.js')),
			__memo(() => import('./chunks/18-D2cwlKKW.js')),
			__memo(() => import('./chunks/19-BMM7Og70.js')),
			__memo(() => import('./chunks/20-x8bVGAyZ.js')),
			__memo(() => import('./chunks/21-DM3eka7D.js'))
		],
		routes: [
			{
				id: "/(user)",
