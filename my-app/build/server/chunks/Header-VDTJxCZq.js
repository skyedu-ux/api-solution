import { V as ensure_array_like, P as escape_html, v as pop, Q as store_get, W as stringify, R as unsubscribe_stores, t as push } from './index-ChVjjWva.js';
...
function Header($$payload, $$props) {
  ...
  if (!isAdmin) {
    ...
    if (infoData) {
      $$payload.out += "<!--[-->";
      const each_array = ensure_array_like(infoData.socialLinks);
      $$payload.out += `<div class="header-top-wrapper"><ul class="contact-list !mb-0"><li><i class="far fa-envelope"></i> <a${attr("href", `mailto:${infoData.email}`)} class="link svelte-11suql8">${escape_html(infoData.email)}</a></li> <li><i class="fas fa-map-marker-alt"></i> ${escape_html(infoData.address)}</li></ul> <div class="top-right"><div class="social-icon d-flex align-items-center"><!--[-->`;
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        let socialLink = each_array[$$index];
      ...
      $$payload.out += `<!--]--></div> <ul class="header-menu !mb-0"><li><a${attr("href", path.contact.base())} class="svelte-11suql8">Help</a></li> <li><a${attr("href", path.contact.base())} class="svelte-11suql8">Support</a></li></ul></div></div>`;
    } else {
      $$payload.out += "<!--[!-->";
    }
    $$payload.out += `<!--]--></div></div>`;
  ...
  for (let $$index_4 = 0, $$length = each_array_3.length; $$index_4 < $$length; $$index_4++) {
    ...
    if (menuLink.children && !menuLink.hideChildren) {
      $$payload.out += "<!--[-->";
...
//# sourceMappingURL=Header-VDTJxCZq.js.map
