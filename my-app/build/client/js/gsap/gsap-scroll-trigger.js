...
!(function (e, t) {
	...
	function ub(e, t) {
		if (Ka(e)) {
			...
			~r && (e.indexOf('%') > r && (n *= t / 100), (e = e.substr(0, r - 1))),
				(e =
					n +
					(e in I ? I[e] * t : ~e.indexOf('%') ? (parseFloat(e) * t) / 100 : parseFloat(e) || 0));
		}
		return e;
	}
		...
		if (i) {
			...
			(d = 'scroll' + n.d2),
				R(
					...
					_,
					n,
					(T && 20 < _) || (!T && (u ? Math.max(Ge[d], qe[d]) : i.parentNode[d]) <= _ + 1)
				),
	...
	var He,
			...
			if (!ht || e) {
				...
				at && Q.sort(),
					...
					At.forEach(function (e) {
						return (
							'max' === e.vars.end &&
							e.setPositions(e.start, Math.max(e.start + 1, Ia(e.scroller, e._dir)))
						);
					}),
		...
		j = function _updateAll(e) {
			if (!ut || 2 === e) {
				...
				if (
					((Lt = o < U ? -1 : 1),
					(U = o),
					n && (ht && !ot && 200 < r - ht && ((ht = 0), W('scrollEnd')), (rt = _), (_ = r)),
					Lt < 0)
				) {
		...
		Q =
				...
				if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), vt)) {
					...
					if (
						...
						ue &&
							...
							ze.forEach(function (e) {
								return (
									La(e) && e.target === (me ? je.scrollingElement || qe : be) && (e.smooth = !1)
								);
							}),
							(d = La(ue.snapTo)
								? ue.snapTo
					...
					(Te.previous = function () {
								...
								if (ie && e && ht) ob(ScrollTrigger, 'scrollEnd', Gb);
									...
									for (
										La(x) && (x = x(Te)),
											...
											Ka(m) &&
												...
												(~m.indexOf(' ')
													? (m = (Ka(x) ? x.split(' ')[0] : '') + m)
													: ((v = ub(m.substr(2), d)), (m = Ka(x) ? x : P + v), (y = oe))),
											O =
												Math.max(
													P,
													cc(
									...
									if (
										...
										for (n = oe.parentNode; n && n !== Ge; )
											n._pinOffset && ((P -= n._pinOffset), (O -= n._pinOffset)),
												(n = n.parentNode);
									f &&
						...
						(Te.labelToScroll = function (e) {
							return (
								(C && C.labels && (P || Te.refresh() || P) + (C.labels[e] / C.duration()) * L) || 0
							);
						}),
										...
										a && !nt
											? (ve &&
												...
												de &&
													...
													(Oa(Te.callbackAnimation),
													q ? q.progress(1) : Oa(C, 'reverse' === i ? 1 : !p, 1)))
											: ve && Q && !nt && Q(Te);
								}
								if (x) {
			...
			(ScrollTrigger.register = function register(e) {
				return (
					s || ((He = e || Da()), Ca() && window.document && ScrollTrigger.enable(), (s = vt)), s
				);
			}),
	...
	function ic(e, t) {
		!0 === t
			...
			: (e.style.touchAction =
					!0 === t ? 'auto' : t ? 'pan-' + t + (E.isTouch ? ' pinch-zoom' : '') : 'none'),
			e === qe && ic(Ge, t);
	}
	function kc(e) {
		var t,
	...
	function pc(e) {
		...
		var n,
			...
			g = d && d.get(),
			h =
				k && ((e.content && J(e.content)) || (g && !1 !== e.content && !g.smooth() && g.content())),
			v = K(p, Ke),
			b = K(p, Xe),
			m = 1,
			y =
		...
		return (
			...
			(e.onChange = function (e, t, r, n, o) {
				if (
					(Dt !== l && Hp(), t && f && b(T(n[2] === t ? c + (e.startX - e.x) : b() + t - n[1])), r)
				) {
					v.offset && Ip();
					var i = o[2] === r,
